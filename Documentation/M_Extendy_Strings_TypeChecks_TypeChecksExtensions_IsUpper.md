# TypeChecksExtensions.IsUpper Method 
...
#### Return Value
Type: <a href="https://docs.microsoft.com/dotnet/api/system.boolean" target="_blank">Boolean</a><br />true if the string only contains uppercase letters; otherwise, false.
