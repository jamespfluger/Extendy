...
namespace ExtendyTests.Collections
{
    public class EnumerableExtensionsTests
    {
        ...
        public void CreateManyArgumentNullExceptionTest()
        {
            ...
            Exception thrownException = Assert.Throws<ArgumentNullException>(() => originalArray.CreateMany(5));
            Assert.NotNull(thrownException);
        ...
        public void CreateManyArgumentOutOfRangeExceptionTest()
        {
            ...
            Exception thrownException = Assert.Throws<ArgumentOutOfRangeException>(() => originalArray.CreateMany(-1));
            Assert.NotNull(thrownException);
        ...
        [Fact]
        public void AppendManyArgumentInputNullExceptionTest()
        {
            IEnumerable<string> originalArray = null;

            Exception thrownException = Assert.Throws<ArgumentNullException>(() => originalArray.AppendMany(null, 5));
            Assert.NotNull(thrownException);
            Assert.Equal("Value cannot be null. (Parameter 'source')", thrownException.Message);
        }
        ...
        public void AppendManyArgumentNullExceptionTest()
        {
            ...
            Exception thrownException = Assert.Throws<ArgumentNullException>(() => originalArray.AppendMany(0, 5));
            Assert.NotNull(thrownException);
            Assert.Equal("Value cannot be null. (Parameter 'source')", thrownException.Message);
        }
        ...
        public void AppendManyArgumentOutOfRangeExceptionTest()
        {
            ...
            Exception thrownException = Assert.Throws<ArgumentOutOfRangeException>(() => originalArray.AppendMany(5, -1));
            Assert.NotNull(thrownException);
            Assert.Equal("Specified argument was out of the range of valid values. (Parameter 'count')", thrownException.Message);
        }
    }
